...
const Schedule = () => {
    ...
    piketGroup = [
        ["Aisyah", "Rahmah", "Citra", "Musda", "Ziqra", "Ifhul"],
        ["Heppy", "Mugita", "Aulia", "Fani", "Riank", "Fachry"],
        ["Risda", "Manda", "Sulfa", "Poppy", "Opik", "Rifaldy", "Alif"],
        ["Nur", "Azizah", "Amel", "Asti", "Winnie", "Reski"],
        ["Zatriani", "Rasmi", "Putri", "Ummul", "Afdal", "Sajrul", "Idham"],
    ]
