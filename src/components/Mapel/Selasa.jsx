    ...
    return (
        <>
        	<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">Fisikas</div>
					<div className="flex justify-center items-center text-sm">07:15-09:30</div>
				</div>
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					...
					<div className="flex justify-center items-center text-sm">09:30-10:15</div>
				</div>
				...
				<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1000">
					...
					<div className="flex justify-center items-center text-sm">12:45-14:15</div>
				</div>
				<div className=" border-b-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1100">
					<div className="w-[50%] text-base  font-medium">Bahasa Inggris</div>
					<div className="flex justify-center items-center text-sm">14:15-15:45</div>
				</div>
        </>
    )
} 
