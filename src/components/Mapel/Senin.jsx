    ...
    return (
        <>
        	<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">Upacara Bendera</div>
					<div className="flex justify-center items-center text-sm">07:15-09:00</div>
				</div>
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">Ekonomi Peminatan</div>
					<div className="flex justify-center items-center text-sm">09:00-10:15</div>
				</div>
				...
				<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1000">
					<div className="w-[50%] text-base font-medium">Geografi</div>
					<div className="flex justify-center items-center text-sm">12:45-13:30</div>
				</div>
				<div className="flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="1100">
					<div className="w-[50%] text-base font-medium">Sosiologi</div>
					<div className="flex justify-center items-center text-sm">13:30-15:45</div>
				</div>
        </>
    )
} 
